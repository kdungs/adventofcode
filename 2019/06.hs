...
counts os =
  foldl (\om b -> om >>= countOrbits os b) (Just Map.empty) (Map.keys os)
...
main = do
  ...
  print res
  print $ (\m -> pathLength m (Body "YOU") (Body "SAN")) <$> os
